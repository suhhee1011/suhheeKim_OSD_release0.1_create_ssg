   ...
   return new Promise(function (resolve) {
      ...
      RL.question("Please enter a title for your site:  ", (title) => {
         RL.question(
            ...
            (description) => {
               RL.question(
                  "Please enter a keyword for your site: ",
                  (keyword) => {
                     RL.close();
...
async function readFile(filename, TextArr, Text, cssurl, jsonOutput) {
   fs.readFile(
      fileOrFolder(filename, TextArr, Text),
      "utf8",
      function (error, data) {
         if (error) {
            console.log(
               "This " + Text[0],
               ".",
               Text[1] + " file is not exist. Please check file name",
            );
        ...
        // let metadata;
         ...
         createMetaData().then(function (value) {
